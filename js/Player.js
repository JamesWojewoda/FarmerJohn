...
(function (window) {
    ...
    var MoveAcceleration = 10000.0;
    var MaxMoveSpeed = 1750.0;
    var GroundDragFactor = 0.48;
    var AirDragFactor = 0.48;
    ...
    Player.prototype.initialize = function (imgPlayer, level, position) {
        ...
        this.jumpTime = 0.0;
        frameWidth = 64//this.SpriteSheet.getFrame(0).rect.width;
        frameHeight = 64//localSpriteSheet.getFrame(0).rect.height;
    ...
    Player.prototype.tick = function () {
        ...
        if (this.IsAlive && this.currentAnimation.indexOf("throwing") === -1) {
   ...
   /* Player.prototype.DoubleJump = function (velocityY) {
        // If the player wants to jump
        if (this.isJumping) {
            // Begin or continue a jump
            if (this.wasJumping || this.jumpTime > 0.0) {
                if (this.jumpTime == 0.0) {
                    //this.level.levelContentManager.playerJump.play();
                }
